...
class RvHomeNowPlayingMoviesAdapter @Inject constructor() :
    ListAdapter<MovieModel, RvHomeNowPlayingMoviesAdapter.ProductViewHolder>(PRODUCT_COMPARATOR) {
        ...
        fun bind(model: MovieModel) {
            ...
            binding.apply {
                ...
                root.setOnClickListener {
                    listener.onNowPlayingItemClicked(model)
                }
    ...
    interface OnItemClickListener {
        fun onNowPlayingItemClicked(model: MovieModel)
    }
