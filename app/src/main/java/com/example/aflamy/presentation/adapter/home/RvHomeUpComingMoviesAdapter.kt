...
class RvHomeUpComingMoviesAdapter @Inject constructor() :
    ListAdapter<MovieModel, RvHomeUpComingMoviesAdapter.ProductViewHolder>(PRODUCT_COMPARATOR) {
    ...
    inner class ProductViewHolder(private val binding: ItemMovieHomeBinding) :
        ...
        fun bind(model: MovieModel) {
            ...
            binding.apply {
                ...
                val imageUrl = "https://image.tmdb.org/t/p/w100${model.posterPath}"
                Glide.with(ivMovie.context)
                    .load(imageUrl)
                    .into(ivMovie)

                root.setOnClickListener {
                    listener.onUpComingItemClicked(model)
                }
    ...
    interface OnItemClickListener {
        fun onUpComingItemClicked(model: MovieModel)
    }
